...
- [MySQL Role](roles# Ansible Repository
...
Now, your repository's README.md includes your GitHub username (`civiliman`) and your name (`Iman Sadegh`) as the author of the repository./mysql): A role to install and configure MySQL server.
